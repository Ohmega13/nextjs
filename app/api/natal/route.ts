...
export async function POST(req: NextRequest) {
  ...
  function buildPromptBaseline() {
    return [
      `วิเคราะห์พื้นดวงตามข้อมูลของ ${fullName}, เกิดวันที่ ${dob}, เวลา ${birthTime || "-" }, สถานที่เกิด ${birthPlace || "-"}`,
      `ช่วยวิเคราะห์แบบละเอียดดังนี้:`,
      ...
      `8. พื้นดวงโดยรวม แบบช่วงชีวิต ตั้งแต่เกิดจนถึงอายุ 80 ปี (เหตุการณ์สำคัญ / แนวโน้ม / สิ่งที่ต้องระวัง)`,
      `9. วิเคราะห์เรื่องตัวเลข เลขดี ไม่ดี ใช้สำหรับ เลขบ้าน ทะเบียนรถ เบอร์โทรศัพท์ เลขนำโชค`,
      ``,
      `**รูปแบบคำตอบ**: สรุปเป็นหัวข้อหมายเลข 1–9 ตามลำดับ ชัดเจน กระชับ และแยกย่อหน้า อ่านง่าย เป็นภาษาไทย`
    ].join("\n");
  }
